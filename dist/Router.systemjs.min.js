System.register(['jb-modules/ExceptionHandler/ExceptionHandler', 'react', 'react-dom'], function (exports, module) {
    'use strict';
    var ExceptionHandler, React, ReactDOM;
    return {
              ...
              _createClass(Route, [{
                ...
                value: function _loadResource(path) {
                  return new Promise(function (resolve, reject) {
                    module.import(path).then(function (output) {
                      resolve(output);
                    }).catch(function (e) {
                      reject(e);
                    });
